...
public class PushExample {
    ...
    protected static final String APP_KEY ="7bfd0101daf4f8b48049872c";
    protected static final String MASTER_SECRET = "fe23de1071f6a409579d7e87";
...
//        testSendPushWithCallback();
	...
	public static void testSendPush(String cmd) {
...
//        jpushClient.getPushClient().setHttpClient(httpClient);
        final PushPayload payload = buildPushObject_android_and_ios(null, cmd);
...
//        PushPayload payload = buildPushObject_all_alias_alert();
        try {
            ...
            // 濡傛灉浣跨敤 NettyHttpClient锛岄渶瑕佹墜鍔ㄨ皟鐢� close 鏂规硶閫�鍑鸿繘绋�
...
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
            ...
            Thread thread = new Thread() {
                public void run() {
                    for (int j = 0; j < 200; j++) {
                        ...
                        System.out.println("鑰楁椂" + (System.currentTimeMillis() - start) + "姣 sendCount:" + (++sendCount));
                    }
                }
            };
            thread.start();
    ...
    public void testSendGroupPush() {
        ...
        final PushPayload payload = buildPushObject_android_and_ios(null, null);
        try {
    ...
    public static PushPayload buildPushObject_android_tag_alertWithTitle() {
        return PushPayload.newBuilder()
                ...
                .setAudience(Audience.alias("vm001"))
                .setNotification(Notification.android(ALERT, TITLE, null))
                .build();
    }
    
    public static PushPayload buildPushObject_android_and_ios(String alias, String cmd) {
    	Audience aud = null;
    	if(alias != null) {
    		aud = Audience.alias(alias);
    	} else {
    		aud = Audience.all();
    	}
